...
Every signed round-trip in the paper is produced and checked by the official
``c2patool``, so nothing there establishes that another conforming consumer
reads the custom assertion the same way (Section 9). This experiment covers
part of that limitation, stated below.
