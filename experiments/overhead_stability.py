...
The absolute bookkeeping cost moved by roughly a third between runs weeks apart
with no change to the bookkeeping code. The figure depends on machine state,
and this experiment measures that dependence.
