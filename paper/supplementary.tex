...
\begin{longtable}{p{\dimexpr0.333\linewidth-2\tabcolsep\relax}%
                  ...
                  p{\dimexpr0.333\linewidth-2\tabcolsep\relax}}
\caption{Transfer memo, written before any code was produced: what carries
over from prior work unchanged, what carries over modified, and what does
not carry over.}\label{tab:transfer}\\
\toprule
...
Inherited elements are prior work and are cited, not claimed; every reported
number in this paper is new.}
\label{tab:inherited}
\small
...
constraining what a derived asset may claim relative to them, which is what
this work supplies. Nothing found in the re-run changed a claim in this paper
...
signing credential, runs the named regression tests and experiments A--N,
...
interquartile ranges, the absolute cost figures of Section~7.10 of the
...
Two later runs on the released package are summarised in Section~7.11 of the
...
Experiment~K and in the time-stretch model deviation, on which the two builds
