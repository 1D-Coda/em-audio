"""Regression tests for defects found in the validators and experiments.

Each test encodes a defect reproduced against earlier code. They are written
to FAIL on that code and to pass once fixed, so
...
# --- validators trusted the candidate's own contributor list -----------------
